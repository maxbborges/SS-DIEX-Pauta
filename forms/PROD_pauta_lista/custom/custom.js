...
function carregaTabelas(){
    let dataset = (DatasetFactory.getDataset("DSSolicitacaoDePauta", null, null, null)).values
    ...
    setTimeout(function(){
        ...
        var status = (DatasetFactory.getDataset("processTask", ['status','processTaskPK.colleagueId'], constraints, null)).values
        ...
        for(i=0;i<dataset.length;i++){
            ...
            $('#column9_1___'+(i+1)).prop('href','https://fluig.sestsenat.org.br/portal/p/1/ecmnavigation?app_ecm_navigation_doc='+dataset[i].documentid)
            $('#column10_1___'+(i+1)).prop('href','https://fluig.sestsenat.org.br/portal/p/1/pageworkflowview?app_ecm_workflowview_detailsProcessInstanceID='+dataset[i].ipNumForm)
        }
    }, 500);
